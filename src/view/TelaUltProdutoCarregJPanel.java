 ...
 * @author anderson
 */
public class TelaUltProdutoCarregJPanel extends javax.swing.JPanel {

    private final Image image;
    private final BaseJFrame baseJFrame;
    
    /**
     * Creates new form TelaProdutoUltCarregJPanel
     */
    public TelaUltProdutoCarregJPanel(BaseJFrame baseJFrame) {
    ...
    private void initComponents() {
        ...
        jLabelPerg.setText("O produto a ser carregado é?");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabelProd.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jLabelProd.setForeground(new java.awt.Color(255, 255, 255));
        jLabelProd.setText("Açúcar Ensacado");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.insets = new java.awt.Insets(20, 0, 150, 0);
        add(jLabelProd, gridBagConstraints);
    ...
    private void jButtonNaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNaoActionPerformed
        ...
        this.baseJFrame.getAutomacaoCTR().setConfirmarProduto(false);
    ...
    private void jButtonSimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSimActionPerformed
        ...
        this.baseJFrame.getAutomacaoCTR().setConfirmarProduto(true);
        if (this.baseJFrame.getAutomacaoCTR().getUltViagemBean().getIdProdCarreg().equals("5")) {
