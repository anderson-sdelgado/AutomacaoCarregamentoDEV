 ...
 * @author anderson
 */
public class TelaUltTranspCarregJPanel extends javax.swing.JPanel {
     ...
     */
    public TelaUltTranspCarregJPanel(BaseJFrame baseJFrame) {
    ...
    private void jButtonNaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNaoActionPerformed
        ...
        this.baseJFrame.getAutomacaoCTR().setConfirmarTransp(false);
        this.baseJFrame.mudarTela(Const.TELA_ULT_VEIC_CARREG);
    ...
    private void jButtonSimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSimActionPerformed
        ...
        this.baseJFrame.getAutomacaoCTR().setConfirmarTransp(true);
        this.baseJFrame.mudarTela(Const.TELA_ULT_VEIC_CARREG);
    ...
    private void carreg() {
        jLabelTransp.setText(this.baseJFrame.getAutomacaoCTR().getUltViagemBean().getNomeTransp());
    }
