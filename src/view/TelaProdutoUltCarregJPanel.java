 ...
 * @author anderson
 */
public class TelaProdutoUltCarregJPanel extends javax.swing.JPanel {
     ...
     */
    public TelaProdutoUltCarregJPanel(BaseJFrame baseJFrame) {
    ...
    private void jButtonSimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSimActionPerformed
        ...
        if (this.baseJFrame.getAutomacaoCTR().getDadosCarregBean().getIdProdCarreg().equals("5")) {
