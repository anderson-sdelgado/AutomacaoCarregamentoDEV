 ...
 * @author anderson
 */
public class TelaDadosNEncJPanel extends javax.swing.JPanel {

    private final Image image;
    private final BaseJFrame baseJFrame;

    /**
     * Creates new form TelaDadosNEncJPanel
     *
     * @param baseJFrame
     */
    public TelaDadosNEncJPanel(BaseJFrame baseJFrame) {
    ...
    private void initComponents() {
        ...
        jLabelPerg.setFont(new java.awt.Font("Tahoma", 1, 40)); // NOI18N
        jLabelPerg.setForeground(new java.awt.Color(255, 255, 255));
        jLabelPerg.setText("O numero do seu CPF é 123.546.789-00?");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.insets = new java.awt.Insets(180, 0, 180, 0);
    ...
    private void preenche() {
        jLabelPerg.setText("O numero do seu CPF é " + this.baseJFrame.getAutomacaoCTR().getTextoCPF() + "?");
    }
